...
# Print configuration
run_name = "Dsprites KernelIV::="+", lam1:"+str(lam1)+", lam2:"+str(lam2)+", batch_size:"+str(batch_size)+", max_epochs:"+str(max_epochs)
...
mu0 = torch.rand((len(K_inner_X), 1), dtype=torch.float64)
